...
CLUSTER_COLORS = {
    ...
    'TN':                 tuple([x / 255 for x in [230, 230, 255]]),
    'TP_CLOUD_HIGH':      tuple([x / 255 for x in [ 30, 120, 180]]),
    'TP_CLOUD_MASS_HIGH': tuple([x / 255 for x in [255, 175, 255]]),
    'TP_CLOUD_WIND_HIGH': tuple([x / 255 for x in [ 50, 160, 160]]),
    'TP_MASS_HIGH':       tuple([x / 255 for x in [255, 175, 100]]),
    'TP_WIND_HIGH':       tuple([x / 255 for x in [ 50, 160,  50]]),
